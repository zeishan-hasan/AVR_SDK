...
enum class ENC28J60_ECOCON_REG_CFG {
    CLKOUT_DISABLED,
    CLKOUT_DIVIDED_BY_1 = (1 << ENC28J06_ECOCON_REG_BIT::COCON0),
    CLKOUT_DIVIDED_BY_2 = (1 << ENC28J06_ECOCON_REG_BIT::COCON1),
    CLKOUT_DIVIDED_BY_3 = (1 << ENC28J06_ECOCON_REG_BIT::COCON1) | (1 << ENC28J06_ECOCON_REG_BIT::COCON0),
    CLKOUT_DIVIDED_BY_4 = (1 << ENC28J06_ECOCON_REG_BIT::COCON2),
    CLKOUT_DIVIDED_BY_8 = (1 << ENC28J06_ECOCON_REG_BIT::COCON2) | (1 << ENC28J06_ECOCON_REG_BIT::COCON0)
};
