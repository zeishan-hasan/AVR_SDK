...
void Enc28j60::init()
{
	...
	_spi_writeControlReg(REG_MACON3, regBitToValue(ENC28J60_MACON3_REG_BIT::PADCFG0) | regBitToValue(ENC28J60_MACON3_REG_BIT::TXCRCEN) | regBitToValue(ENC28J60_MACON3_REG_BIT::FRMLNEN) | regBitToValue(ENC28J60_MACON3_REG_BIT::FULDPX));
...
u8t Enc28j60::_spi_readControlReg(ENC28J60_REGS reg)
{
	...
	return _spi_readOpcode(reg | SPI_OPCODE_RCR);
}
